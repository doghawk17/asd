...
<head>
  ...
  <title>Client Registration | Upwork Clone</title>
</head>
<body>
  <div class="container">
      ...
      <div class="col-md-8">
        <div class="register-card">
          <div class="register-header">
            ...
            <p class="mb-0">Create your client account to post gigs and hire freelancers</p>
          </div>
          ...
          <div class="register-footer">
            <p class="mb-0">Already have an account? <a href="login.php">Login as a Client</a></p>
            <p class="mt-2 mb-0">Are you a freelancer? <a href="../freelancer/register.php">Register as Freelancer</a></p>
          </div>
        </div>
      </div>
    </div>
